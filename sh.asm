...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      27:	e8 3e 0d 00 00       	call   d6a <open>
...
fork1(void)
{
  ...
  exit();
      ...
      if(chdir(buf+3) < 0)
      d6:	e8 bf 0c 00 00       	call   d9a <chdir>
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     19c:	52                   	push   %edx
     19d:	50                   	push   %eax
     19e:	e8 bf 0b 00 00       	call   d62 <exec>
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1ed:	e8 78 0b 00 00       	call   d6a <open>
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     2b5:	e8 e8 0a 00 00       	call   da2 <dup>
      close(p[0]);
     2ba:	59                   	pop    %ecx
     ...
     2f0:	e8 ad 0a 00 00       	call   da2 <dup>
      close(p[0]);
     2f5:	58                   	pop    %eax
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c5d:	e8 08 01 00 00       	call   d6a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     c71:	50                   	push   %eax
     c72:	e8 0b 01 00 00       	call   d82 <fstat>
  close(fd);
...
00000d5a <set_prio>:
SYSCALL(set_prio)
     d5a:	b8 16 00 00 00       	mov    $0x16,%eax
     d5f:	cd 40                	int    $0x40
     d61:	c3                   	ret    

00000d62 <exec>:
SYSCALL(exec)
     d62:	b8 07 00 00 00       	mov    $0x7,%eax
     d67:	cd 40                	int    $0x40
     d69:	c3                   	ret    

00000d6a <open>:
SYSCALL(open)
     d6a:	b8 0f 00 00 00       	mov    $0xf,%eax
     d6f:	cd 40                	int    $0x40
     d71:	c3                   	ret    

00000d72 <mknod>:
SYSCALL(mknod)
     d72:	b8 11 00 00 00       	mov    $0x11,%eax
     d77:	cd 40                	int    $0x40
     d79:	c3                   	ret    

00000d7a <unlink>:
SYSCALL(unlink)
     d7a:	b8 12 00 00 00       	mov    $0x12,%eax
     d7f:	cd 40                	int    $0x40
     d81:	c3                   	ret    

00000d82 <fstat>:
SYSCALL(fstat)
     d82:	b8 08 00 00 00       	mov    $0x8,%eax
     d87:	cd 40                	int    $0x40
     d89:	c3                   	ret    

00000d8a <link>:
SYSCALL(link)
     d8a:	b8 13 00 00 00       	mov    $0x13,%eax
     d8f:	cd 40                	int    $0x40
     d91:	c3                   	ret    

00000d92 <mkdir>:
SYSCALL(mkdir)
     d92:	b8 14 00 00 00       	mov    $0x14,%eax
     d97:	cd 40                	int    $0x40
     d99:	c3                   	ret    

00000d9a <chdir>:
SYSCALL(chdir)
     d9a:	b8 09 00 00 00       	mov    $0x9,%eax
     d9f:	cd 40                	int    $0x40
     da1:	c3                   	ret    

00000da2 <dup>:
SYSCALL(dup)
     da2:	b8 0a 00 00 00       	mov    $0xa,%eax
     da7:	cd 40                	int    $0x40
     da9:	c3                   	ret    

00000daa <getpid>:
SYSCALL(getpid)
     daa:	b8 0b 00 00 00       	mov    $0xb,%eax
     daf:	cd 40                	int    $0x40
     db1:	c3                   	ret    
