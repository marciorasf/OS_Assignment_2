...
main(void)
{
  ...
  b0:	e8 dd 02 00 00       	call   392 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  d2:	e8 cb 02 00 00       	call   3a2 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 f8 07 00 00       	push   $0x7f8
  e0:	e8 b5 02 00 00       	call   39a <open>
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 08 01 00 00       	call   39a <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 0b 01 00 00       	call   3b2 <fstat>
  close(fd);
